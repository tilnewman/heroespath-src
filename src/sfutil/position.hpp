...
namespace sfutil
{
    ...
    const sf::Vector2f Position(const sfml_util::Text &);
    ...
    float Left(const sfml_util::Text &);
    ...
    float Right(const sfml_util::Text &);
    ...
    float Top(const sfml_util::Text &);
    ...
    float Bottom(const sfml_util::Text &);
