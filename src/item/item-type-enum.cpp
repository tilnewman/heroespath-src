...
namespace item
{
        ...
        category::ToStringPopulate(const EnumUnderlying_t ENUM_VALUE, const std::string & SEPARATOR)
    {
        ...
        AppendNameIfBitIsSet(
            str, ENUM_VALUE, category::ConsumedOnUse, "consumed upon use", SEPARATOR);

        AppendNameIfBitIsSet(
            str, ENUM_VALUE, category::ShowsEnemyInfo, "shows enemy info", SEPARATOR);
    ...
    {
        if (((ENUM & element_type::Fire) && (ENUM & element_type::Frost))
            || ((ENUM & element_type::Honor) && (ENUM & element_type::Shadow)))
        {
            return false;
        }
        else
    ...
    const std::string misc_type::ToString(const misc_type::Enum MISC_TYPE)
    {
        switch (MISC_TYPE)
        {
            ...
            case BasiliskTongue: { return "BasiliskTongue";
            }
    ...
    bool misc_type::IsBlessed(const misc_type::Enum ENUM)
    {
        return (
    ...
    bool misc_type::IsCursed(const misc_type::Enum ENUM)
    {
        return (
        ...
        name_material_type::ToString(const name_material_type::Enum NAME_MATERIAL_TYPE)
    {
        switch (NAME_MATERIAL_TYPE)
        {
            ...
            case name_material_type::Clasped: { return "Clasped";
            }
            case name_material_type::ClaspedWithBase: { return "ClaspedWithBase";
            }
            case name_material_type::Count: { return "(Count)";
            }
            default:
            {
                M_HP_LOG_ERR(
