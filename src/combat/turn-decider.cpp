...
namespace combat
{
        ...
        CombatDisplayCPtrC_t           COMBAT_DISPLAY_CPTRC)
    {
            ...
            (LIVING_PLAYERS_IN_ATTACK_RANGE.empty() == false))
        {
            ...
            {
                M_HP_LOG_WRN("combat::TurnDecider::Decide("
        ...
        const creature::CreaturePtrC_t MOST_DESIRED_TARGET_CPTRC)
    {
        ...
        std::copy_if(ALL_SPELLS_PVEC.begin(),
                     ...
                     {
                        return ((S_PTR->Effect() != combat::EffectType::ItemHarmBreak) &&
                ...
                combat::strategy::RefineType::Murderer))
        {
            ...
            pVec_OutParam = creature::Algorithms::FindByHasCondition(
                pVec_OutParam, creature::Conditions::Unconscious);
                 ...
                 (misc::random::Float(1.0f) < game::GameDataFile::Instance()->GetCopyFloat(
