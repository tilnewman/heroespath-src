...
namespace trap
{
    ...
    {
        M_ASSERT_OR_LOGANDTHROW_SS((traps_.empty() == false),
            "combat::trap::Warehouse::GetWithMinSeverity() called before warehouse was Fill()ed.");
        ...
        const float THE_MAX)
    {
        ...
        {
            M_HP_LOG_ERR("combat::trap::Warehouse::GetWithSeverityRatioBetween(min=" << THE_MIN
                << ", max=" << THE_MAX << ") "
