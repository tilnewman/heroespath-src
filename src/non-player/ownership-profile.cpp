...
namespace ownership
{
    ...
    const std::string wealth_type::ToString(const wealth_type::Enum E)
    {
        switch (E)
        {
            ...
            default:
            {
                ...
                ss << "non_player::ownership::wealth_type::ToString("
    ...
    const std::string collector_type::ToString(const collector_type::Enum E)
    {
        ...
        if (ss.str().empty())
        {
            ...
            ssErr << "non_player::ownership::collector_type::ToString("
                << E << ")_InvalidValueError";
    ...
    collector_type::Enum collector_type::FromCreature(const CharacterPtr_t CHARACTER_PTR)
    {
        ...
        auto const RACE_COLLECTOR_PARTS_STR{ game::GameDataFile::Instance()->GetCopyStr(RACE_KEY) };
        ...
        auto const ROLE_COLLECTOR_PARTS_STR{ game::GameDataFile::Instance()->GetCopyStr(ROLE_KEY) };
    ...
    owns_magic_type::Enum owns_magic_type::FromCreature(const CharacterPtr_t CHARACTER_PTR)
    {
        ...
        //adjust for race
        {
            ...
            auto const RACE_OWNSMAGIC_PARTS_STR{ game::GameDataFile::Instance()->GetCopyStr(RACE_KEY) };
        ...
        //adjust for role
        {
            ...
            auto const ROLE_OWNSMAGIC_PARTS_STR{ game::GameDataFile::Instance()->GetCopyStr(ROLE_KEY) };
    ...
    const std::string complexity_type::ToString(const complexity_type::Enum E)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "non_player::ownership::complexity_type::ToString("
                    << E << ")_InvalidValueError.";
