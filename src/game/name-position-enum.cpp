...
namespace game
{
    ...
    ContentAndNamePos::ContentAndNamePos(const std::string &      PRE_STR,
    ...
    ContentAndNamePos::ContentAndNamePos(const std::string &      CONTENT_STR,
                                         const NamePosition::Enum NAME_POS_ENUM)
    :
        pre_    (""),
        content_(CONTENT_STR),
    ...
    const std::string ContentAndNamePos::Compose(const std::string & SOURCE_NAME,
