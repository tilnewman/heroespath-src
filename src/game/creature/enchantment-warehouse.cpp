...
namespace creature
{
    ...
    :
        warehouse_()
    {
        M_HP_LOG_DBG("Singleton Construction: Player EnchantmentWarehouse");
    }


    EnchantmentWarehouse::~EnchantmentWarehouse()
    {
        M_HP_LOG_DBG("Singleton Destruction: Player EnchantmentWarehouse");
    }
    ...
    EnchantmentWarehouse * EnchantmentWarehouse::Instance()
    {
        ...
        {
            M_HP_LOG_WRN("Singleton Instance() before Acquire(): Player EnchantmentWarehouse");
            Acquire();
        }
    ...
    void EnchantmentWarehouse::Acquire()
    {
        ...
        {
            M_HP_LOG_WRN("Singleton Acquire() after Construction: Player EnchantmentWarehouse");
        }
    }
    ...
    void EnchantmentWarehouse::Release()
    {
        M_ASSERT_OR_LOGANDTHROW_SS((instanceUPtr_.get() != nullptr),
            "game::player::EnchantmentWarehouse::Release() found instanceUPtr that was null.");
