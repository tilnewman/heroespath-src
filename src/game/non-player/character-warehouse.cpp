...
namespace non_player
{
    ...
    void CharacterWarehouse::Release()
    {
        M_ASSERT_OR_LOGANDTHROW_SS((instanceUPtr_.get() != nullptr),
            "game::non_player::CharacterWarehouse::Release() found instanceUPtr that was null.");
    ...
    CharacterPtr_t CharacterWarehouse::Store(const CharacterPtr_t CHARACTER_PTR)
    {
        M_ASSERT_OR_LOGANDTHROW_SS((CHARACTER_PTR != nullptr),
            "game::non_player::CharacterWarehouse::Store() given a nullptr.");
        ...
        for (std::size_t i(0); i<NUM_CHARACTERS; ++i)
        {
            ...
            if (NEXT_CHARACTER_PTR == CHARACTER_PTR)
            {
                ...
                ss << "game::non_player::CharacterWarehouse::Store((" << CHARACTER_PTR
    ...
    void CharacterWarehouse::Free(CharacterPtr_t & creaturePtr)
    {
        M_ASSERT_OR_LOGANDTHROW_SS((creaturePtr != nullptr),
            "game::non_player::CharacterWarehouse::Free() given a nullptr.");
        ...
        M_HP_LOG_ERR("game::non-player::CharacterWarehouse::Free((" << creaturePtr
