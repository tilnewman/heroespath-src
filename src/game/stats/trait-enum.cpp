...
namespace stats
{
    ...
    const std::string Traits::ToString(const Enum E)
    {
        switch (E)
        {
            ...
            case FindReligious:     { return "FindReligious"; }
            case FindMagic:         { return "FindMagic"; }
            case FindCoinsAmount:   { return "FindCoinsAmount"; }
            ...
            case DamageBonusAll:    { return "DamageBonusAll"; }
            case PoisonOnMelee:     { return "PoisonOnMelee"; }
            case PoisonOnAll:       { return "PoisonOnAll"; }
            case PanicOnSpell:      { return "PanicOnSpell"; }
            case CurseCast:         { return "CurseCast"; }
            case CurseEffect:       { return "CurseEffect"; }
            case CurseResist:       { return "CurseResist"; }
            case CurseOnDamage:     { return "CurseOnDamage"; }
            case BlessCast:         { return "BlessCast"; }
            case BlessEffect:       { return "BlessEffect"; }
            case BlessResist:       { return "BlessResist"; }
            case HitPower:          { return "HitPower"; }
            case HitCritical:       { return "HitCritical"; }
            case FireDamage:        { return "FireDamage"; }
            case FireResist:        { return "FireResist"; }
            case FrostDamage:       { return "FrostDamage"; }
            case FrostResist:       { return "FrostResist"; }
            case HonorDamage:       { return "HonorDamage"; }
            case HonorResist:       { return "HonorResist"; }
            case ShadowDamage:      { return "ShadowDamage"; }
            case ShadowResist:      { return "ShadowResist"; }
            case Count:
            default:
            {
                std::ostringstream ss;
                ss << "game::stats::Traits::ToString(" << E << ")_InvalidValueError";
    ...
    const std::string Traits::Abbr(const Enum E)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "game::stats::Traits::Abbr(" << E << ")_InvalidValueError";
                throw std::range_error(ss.str());
            }
        }
    }
    ...
    const std::string Traits::Name(const Enum E)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "game::stats::Traits::Name(" << E << ")_InvalidValueError";
                throw std::range_error(ss.str());
            }
        }
    }
