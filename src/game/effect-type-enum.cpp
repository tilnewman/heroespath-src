...
namespace game
{
    ...
    const std::string EffectType::ToString(const Enum E)
    {
        switch (E)
        {
            ...
            default:
            {
                ...
                ss << "game::EffectType::ToString(" << E << ")_InvalidValueError";
    ...
    const std::string EffectType::Name(const Enum E)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "game::EffectType::Name(" << E << ")_InvalidValueError";
                throw std::runtime_error(ss.str());
            }
        }
    }
