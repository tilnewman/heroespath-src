...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef GAME_STAGE_TREASURESTAGEMOVER_HPP_INCLUDED
#define GAME_STAGE_TREASURESTAGEMOVER_HPP_INCLUDED
//
...
namespace treasure
{
    ...
    //Entities on the left side of the screen are called Treasure objects because they correspond
    //to the source of Treasure.  Entities on the right side of the screen are called Inventory
    //objects because they correspond to a character's inventory.  This class is responsible for
    //managing the state of each object and for presenting an interface for sliding them on and
    //off screen.
    class StageMover
    {
        StageMover() =delete;
...
#endif //GAME_STAGE_TREASURESTAGEMOVER_HPP_INCLUDED
