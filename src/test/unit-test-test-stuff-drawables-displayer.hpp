...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_UNIT_TEST_TEST_STUFF_DRAWABLES_DISPLAYER_INCLUDED
#define HEROESPATH_UNIT_TEST_TEST_STUFF_DRAWABLES_DISPLAYER_INCLUDED
//
...
#endif // HEROESPATH_UNIT_TEST_TEST_STUFF_DRAWABLES_DISPLAYER_INCLUDED
