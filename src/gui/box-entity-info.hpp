...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_GUI_BOX_ENTITY_INFO_HPP_INCLUDED
#define HEROESPATH_GUI_BOX_ENTITY_INFO_HPP_INCLUDED
//
// box-entity-info.hpp
//
...
namespace gui
{
    ...
    struct BoxEntityInfo
    {
        ...
        // TARGET_SIZE_V is zero or less then that dimension is ignored
        void SetupImage(
            const CachedTexture & CACHED_TEXTURE,
...
#endif // HEROESPATH_GUI_BOX_ENTITY_INFO_HPP_INCLUDED
