...
namespace gui
{
    ...
    // Responsible for storing and drawing a gui gold bar, which is just a fat line that is
    ...
    // valid object will be created that draws nothing.  This class is just a fancy
    ...
    public:
        ...
        // ORIENTATION is only used to determine which region dimension is the length, defaults
        ...
        // ORIENTATION is only used to determine which dimension is the length, defaults to
        // longest dimension
        explicit GoldBar(
        ...
        // if a rect border then the max dimension is returned
    ...
    // intentionally ignoring the texture because it will be the same for all GoldBars
