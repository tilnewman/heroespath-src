...
namespace gui
{
    ...
    const std::string sound_effect::ToString(const sound_effect::Enum ENUM)
    {
        switch (ENUM)
        {
            ...
            case Shards: { return "meteor_shards";
            }
            ...
            case TentacleHit1: { return "tentacle-hit-1";
            }
            case TentacleHit2: { return "tentacle-hit-2";
            }
            case TentacleHit3: { return "tentacle-hit-3";
            }
            case TentacleHit4: { return "tentacle-hit-4";
            }
            ...
            case RoarDragonFirebrandWhelp: { return "dragon-firebrand-whelp";
            }
            ...
            case RoarDragonSylavinWhelp: { return "dragon-sylavin-whelp";
            }
            ...
            case DeathBeastRough1: { return "beast-rough-1";
            }
            case DeathBeastRough2: { return "beast-rough-2";
            }
            case DeathBeastRough3: { return "beast-rough-3";
            }
