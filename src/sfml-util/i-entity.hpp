...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_I_ENTITY_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_I_ENTITY_HPP_INCLUDED
//
// i-entity.hpp
//
...
#include "sfml-util/i-clickable.hpp"
...
#endif // HEROESPATH_SFMLUTIL_I_ENTITY_HPP_INCLUDED
