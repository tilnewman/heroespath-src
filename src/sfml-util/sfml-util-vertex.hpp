...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_SFMLUTIL_VERTEX_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_SFMLUTIL_VERTEX_HPP_INCLUDED
//
// sfml-util-vertex.hpp
//
...
namespace sfml_util
{
    ...
    const std::vector<sf::Vector2f> MakeQuadVertexPositions(
        ...
        const Orientation::Enum ORIENTATIONS_TO_DRAW_FROM_END = Orientation::Count);
...
#endif // HEROESPATH_SFMLUTIL_SFMLUTIL_VERTEX_HPP_INCLUDED
