...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_SFMLUTIL_VECTOR_MATH_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_SFMLUTIL_VECTOR_MATH_HPP_INCLUDED
//
// sfml-util-vector-math.hpp
//
...
#endif // HEROESPATH_SFMLUTIL_SFMLUTIL_VECTOR_MATH_HPP_INCLUDED
