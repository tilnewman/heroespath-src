...
namespace sfml_util
{
    namespace gui
    {
            ...
            , isMouseOverRegion_(false)
        {
            ...
            const auto TEXTURE_RECT_UP { GuiElementsTextureRect(
                IS_RADIO_BUTTON, true, BRIGHTNESS) };

            const auto TEXTURE_RECT_DOWN { GuiElementsTextureRect(
                IS_RADIO_BUTTON, false, BRIGHTNESS) };
            ...
            textEntityUPtr_ = std::make_unique<sfml_util::gui::TextEntity>(
            ...
            imageEntityUPtr_ = std::make_unique<sfml_util::gui::ImageEntity>(
