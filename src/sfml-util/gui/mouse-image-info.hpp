...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_GUI_MOUSE_IMAGE_INFO_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_GUI_MOUSE_IMAGE_INFO_HPP_INCLUDED
//
...
inline std::ostream & operator<<(std::ostream & os, const sfml_util::gui::MouseImageInfo & MII)
{
    os << MII.ToString();
    return os;
}
...
#endif // HEROESPATH_SFMLUTIL_GUI_MOUSE_IMAGE_INFO_HPP_INCLUDED
