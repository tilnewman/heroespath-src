...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_GUI_LISTBOX_PACKET_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_GUI_LISTBOX_PACKET_HPP_INCLUDED
//
// list-box-packet.hpp
//
...
#endif // HEROESPATH_SFMLUTIL_GUI_LISTBOX_PACKET_HPP_INCLUDED
