...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_GUI_IMAGE_ENTITY_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_GUI_IMAGE_ENTITY_HPP_INCLUDED
//
// image-entity.hpp
//
...
namespace sfml_util
{
    namespace gui
    {
        ...
        public:
            ...
            const EntityImageInfo & FromMouseState() const
            {
                return FromMouseState(GetMouseState());
            }
...
#endif // HEROESPATH_SFMLUTIL_GUI_IMAGE_ENTITY_HPP_INCLUDED
