...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_GUI_I_ENTITY_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_GUI_I_ENTITY_HPP_INCLUDED
//
// i-entity.hpp
//
...
#endif // HEROESPATH_SFMLUTIL_GUI_I_ENTITY_HPP_INCLUDED
