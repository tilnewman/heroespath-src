...
namespace sfml_util
{
    namespace gui
    {
        ...
        public:
            ...
            inline float GetLineSmallBoxPadLeft() const
            {
                return 8.0f;
            ...
            inline const sf::IntRect GetRect_RadioButtonBrightOff() const
            {
                return radioButtonBrightOffSpriteRect_;
            }
            inline const sf::IntRect GetRect_RadioButtonBrightOn() const
            {
                return radioButtonBrightOnSpriteRect_;
            }
            inline const sf::IntRect GetRect_RadioButtonMedOff() const
            {
                return radioButtonMedOffSpriteRect_;
            }
            inline const sf::IntRect GetRect_RadioButtonMedOn() const
            {
                return radioButtonMedOnSpriteRect_;
            }
            inline const sf::IntRect GetRect_RadioButtonDarkOff() const
            {
                return radioButtonDarkOffSpriteRect_;
            }
            inline const sf::IntRect GetRect_RadioButtonDarkOn() const
            {
                return radioButtonDarkOnSpriteRect_;
            }
            inline const sf::IntRect GetRect_CheckBoxMedOff() const
            {
                return checkBoxMedOffSpriteRect_;
            }
            inline const sf::IntRect GetRect_CheckBoxMedOn() const
            {
                return checkBoxMedOnSpriteRect_;
            }
            inline const sf::IntRect GetRect_CheckBoxBrightOff() const
            {
                return checkBoxBrightOffSpriteRect_;
            }
            inline const sf::IntRect GetRect_CheckBoxBrightOn() const
            {
                return checkBoxBrightOnSpriteRect_;
            }
            inline const sf::IntRect GetRect_CheckBoxDarkOff() const
            {
                return checkBoxDarkOffSpriteRect_;
            }
            inline const sf::IntRect GetRect_CheckBoxDarkOn() const
            {
                return checkBoxDarkOnSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowMinusLeftMed() const
            {
                return arrowMinusLeftMedSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowPlusRightMed() const
            {
                return arrowPlusRightMedSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowMinusLeftBright() const
            {
                return arrowMinusLeftBrightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowPlusRightBright() const
            {
                return arrowPlusRightBrightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowMinusLeftDark() const
            {
                return arrowMinusLeftDarkSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowPlusRightDark() const
            {
                return arrowPlusRightDarkSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowMinusDownBright() const
            {
                return arrowMinusDownBrightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowPlusUpBright() const
            {
                return arrowPlusUpBrightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowMinusDownMed() const
            {
                return arrowMinusDownMedSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowPlusUpMed() const
            {
                return arrowPlusUpMedSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowMinusDownDark() const
            {
                return arrowMinusDownDarkSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowPlusUpDark() const
            {
                return arrowPlusUpDarkSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowLeftMed() const
            {
                return arrowLeftMedSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowRightMed() const
            {
                return arrowRightMedSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowDownMed() const
            {
                return arrowDownMedSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowUpMed() const { return arrowUpMedSpriteRect_; }
            inline const sf::IntRect GetRect_ArrowLeftBright() const
            {
                return arrowLeftBrightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowRightBright() const
            {
                return arrowRightBrightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowDownBright() const
            {
                return arrowDownBrightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowUpBright() const
            {
                return arrowUpBrightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowLeftDark() const
            {
                return arrowLeftDarkSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowRightDark() const
            {
                return arrowRightDarkSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowDownDark() const
            {
                return arrowDownDarkSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowUpDark() const { return arrowUpDarkSpriteRect_; }
            inline const sf::IntRect GetRect_ArrowLargeLeft() const
            {
                return arrowLargeLeftSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowLargeUp() const
            {
                return arrowLargeUpSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowLargeRight() const
            {
                return arrowLargeRightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowLargeDown() const
            {
                return arrowLargeDownSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowSmallLeft() const
            {
                return arrowSmallLeftSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowSmallUp() const
            {
                return arrowSmallUpSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowSmallRight() const
            {
                return arrowSmallRightSpriteRect_;
            }
            inline const sf::IntRect GetRect_ArrowSmallDown() const
            {
                return arrowSmallDownSpriteRect_;
            }
            inline const sf::IntRect GetRect_BoxSmall() const { return boxSmallSpriteRect_; }
            inline const sf::IntRect GetRect_PadVerticalSmall() const
            {
                return padVerticalSmallSpriteRect_;
            }
            inline const sf::IntRect GetRect_PadVerticalLarge() const
            {
                return padVerticalLargeSpriteRect_;
            }
            inline const sf::IntRect GetRect_PadHorizontalLarge() const
            {
                return padHorizontalLargeSpriteRect_;
            }
            inline const sf::IntRect GetRect_HorizontalLineLarge() const
            {
                return horizontalLineLargeSpriteRect_;
            }
            inline const sf::IntRect GetRect_HorizontalLineSmall() const
            {
                return horizontalLineSmallSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallVerticalLeft() const
            {
                return lineSmallVerticalLeftSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallVerticalRight() const
            {
                return lineSmallVerticalRightSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallEndLeft() const
            {
                return lineSmallEndLeftSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallEndRight() const
            {
                return lineSmallEndRightSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallEndTop() const
            {
                return lineSmallEndTopSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallEndBot() const
            {
                return lineSmallEndBotSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallCornerTopLeft() const
            {
                return lineSmallCornerTopLeftSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallCornerTopRight() const
            {
                return lineSmallCornerTopRightSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallCornerBotLeft() const
            {
                return lineSmallCornerBotLeftSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallCornerBotRight() const
            {
                return lineSmallCornerBotRightSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallHorizontalTop() const
            {
                return lineSmallHorizontalTopSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallHorizontalBot() const
            {
                return lineSmallHorizontalBotSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallCross() const
            {
                return lineSmallCrossSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallTTop() const
            {
                return lineSmallTTopSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallTLeft() const
            {
                return lineSmallTLeftSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallTBot() const
            {
                return lineSmallTBotSpriteRect_;
            }
            inline const sf::IntRect GetRect_LineSmallTRight() const
            {
                return lineSmallTRightSpriteRect_;
            }
