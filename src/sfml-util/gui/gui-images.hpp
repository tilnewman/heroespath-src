...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_GUI_GUI_IMAGES_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_GUI_GUI_IMAGES_HPP_INCLUDED
//
// gui-images.hpp
//
...
namespace sfml_util
{
    namespace gui
    {
        ...
        struct GuiImages
        {
            ...
            static const sf::FloatRect CheckBoxMedOffF()
            {
                return sf::FloatRect(CheckBoxMedOffI());
            }
            ...
            static const sf::FloatRect CheckBoxDarkOffF()
            {
                return sf::FloatRect(CheckBoxDarkOffI());
            }
            static const sf::IntRect CheckBoxDarkOnI() { return sf::IntRect(0, 23, 26, 23); }
            static const sf::FloatRect CheckBoxDarkOnF()
            {
                return sf::FloatRect(CheckBoxDarkOnI());
            }
            ...
            static const sf::IntRect ArrowPlusRightBrightI()
            {
            ...
            static const sf::IntRect ArrowMinusDownBrightI()
            {
            ...
            static const sf::FloatRect ArrowPlusUpMedF()
            {
                return sf::FloatRect(ArrowPlusUpMedI());
            }
            ...
            static const sf::FloatRect ArrowPlusUpDarkF()
            {
                return sf::FloatRect(ArrowPlusUpDarkI());
            }
            ...
            static const sf::FloatRect ArrowLeftBrightF()
            {
                return sf::FloatRect(ArrowLeftBrightI());
            }
            ...
            static const sf::FloatRect ArrowDownBrightF()
            {
                return sf::FloatRect(ArrowDownBrightI());
            }
            ...
            static const sf::FloatRect ArrowRightDarkF()
            {
                return sf::FloatRect(ArrowRightDarkI());
            }
            ...
            static const sf::FloatRect ArrowLargeLeftF()
            {
                return sf::FloatRect(ArrowLargeLeftI());
            }
            ...
            static const sf::FloatRect ArrowLargeRightF()
            {
                return sf::FloatRect(ArrowLargeRightI());
            }
            static const sf::IntRect ArrowLargeDownI() { return sf::IntRect(72, 114, 36, 36); }
            static const sf::FloatRect ArrowLargeDownF()
            {
                return sf::FloatRect(ArrowLargeDownI());
            }
            static const sf::IntRect ArrowSmallLeftI() { return sf::IntRect(108, 114, 28, 28); }
            static const sf::FloatRect ArrowSmallLeftF()
            {
                return sf::FloatRect(ArrowSmallLeftI());
            }
            ...
            static const sf::FloatRect ArrowSmallRightF()
            {
                return sf::FloatRect(ArrowSmallRightI());
            }
            static const sf::IntRect ArrowSmallDownI() { return sf::IntRect(192, 114, 28, 28); }
            static const sf::FloatRect ArrowSmallDownF()
            {
                return sf::FloatRect(ArrowSmallDownI());
            }
            ...
            static const sf::IntRect LineSmallVerticalLeftI()
            {
            ...
            static const sf::IntRect LineSmallVerticalRightI()
            {
            ...
            static const sf::FloatRect LineSmallEndTopF()
            {
                return sf::FloatRect(LineSmallEndTopI());
            }
            static const sf::IntRect LineSmallEndBotI() { return sf::IntRect(243, 65, 12, 14); }
            static const sf::FloatRect LineSmallEndBotF()
            {
                return sf::FloatRect(LineSmallEndBotI());
            }
            static const sf::IntRect LineSmallCornerTopLeftI()
            {
            ...
            static const sf::IntRect LineSmallCornerTopRightI()
            {
            ...
            static const sf::IntRect LineSmallCornerBotLeftI()
            {
            ...
            static const sf::IntRect LineSmallCornerBotRightI()
            {
            ...
            static const sf::IntRect LineSmallHorizontalTopI()
            {
            ...
            static const sf::IntRect LineSmallHorizontalBotI()
            {
            ...
            static const sf::FloatRect LineSmallCrossF()
            {
                return sf::FloatRect(LineSmallCrossI());
            }
            ...
            static const sf::FloatRect LineSmallTLeftF()
            {
                return sf::FloatRect(LineSmallTLeftI());
            }
            ...
            static const sf::FloatRect LineSmallTRightF()
            {
                return sf::FloatRect(LineSmallTRightI());
            }
        };
...
#endif // HEROESPATH_SFMLUTIL_GUI_GUI_IMAGES_HPP_INCLUDED
