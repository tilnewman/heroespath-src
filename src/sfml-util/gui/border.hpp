...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_GUI_BORDER_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_GUI_BORDER_HPP_INCLUDED
//
// border.hpp
//
...
namespace sfml_util
{
    namespace gui
    {
        ...
        public:
            ...
            bool WillDraw() const { return IsAny(); }
            bool IsAny() const { return (rectangleShapesOpt_ || goldBarOpt_); }
...
#endif // HEROESPATH_SFMLUTIL_GUI_BORDER_HPP_INCLUDED
