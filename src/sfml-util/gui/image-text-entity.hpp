...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_GUI_MOUSESTATE_ENTITY_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_GUI_MOUSESTATE_ENTITY_HPP_INCLUDED
//
    ...
    namespace gui
    {
        ...
        public:
            ...
            struct MouseStateSync
                : public misc::EnumBaseCounting<MouseStateSync, misc::EnumFirstValueNone>
            {
...
#endif // HEROESPATH_SFMLUTIL_GUI_MOUSESTATE_ENTITY_HPP_INCLUDED
