...
namespace sfml_util
{
    namespace gui
    {
        ...
        const EntityImageInfo &
            MouseImageInfo::FromMouseState(const MouseState::Enum MOUSE_STATE) const
        {
        ...
        MouseState::Enum MouseImageInfo::ToDraw(const MouseState::Enum MOUSE_STATE) const
        {
            ...
            else if ((MOUSE_STATE == MouseState::Down) && down.HasTexture())
            {
                ...
                ((MOUSE_STATE == MouseState::Up) || will_draw_up_if_missing) && up.HasTexture())
            {
            ...
            const bool WILL_PREFIX, const misc::Wrap WILL_WRAP, const std::string & SEPARATOR) const
        {
            ...
            if (WILL_PREFIX)
            {
                return std::string("MouseImageInfo")
