...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_SLIDER_COLOR_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_SLIDER_COLOR_HPP_INCLUDED
//
// slider-color.hpp
//
...
#endif // HEROESPATH_SFMLUTIL_SLIDER_COLOR_HPP_INCLUDED
