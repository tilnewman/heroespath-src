...
// ----------------------------------------------------------------------------
#ifndef HEROESPATH_SFMLUTIL_TEXT_HPP_INCLUDED
#define HEROESPATH_SFMLUTIL_TEXT_HPP_INCLUDED
//
// text.hpp
//
...
inline std::ostream & operator<<(std::ostream & os, const sfml_util::Text & TEXT)
{
    os << TEXT.ToString();
    return os;
}
...
#endif // HEROESPATH_SFMLUTIL_TEXT_HPP_INCLUDED
