...
namespace sfml_util
{
    ...
    const float     PopupStageSpellbook::SPELLBOOK_POPUP_BACKGROUND_WIDTH_RATIO_ { 0.85f };
    const float     PopupStageSpellbook::SPELLBOOK_COLOR_FADE_SPEED_             { 6.0f };
    const sf::Uint8 PopupStageSpellbook::SPELLBOOK_IMAGE_ALPHA_                  { 192 };
    const sf::Color PopupStageSpellbook::SPELL_UNABLE_TEXT_COLOR_{ sf::Color(127, 32, 32) };
    const float     PopupStageSpellbook::SPELL_WARNING_DURATION_SEC_             { 2.0f };
    ...
    void PopupStageSpellbook::SetupOuterAndInnerRegion()
    {
        auto const SPELLBOOK_WIDTH{ sfml_util::Display::Instance()->GetWinWidth() *
            SPELLBOOK_POPUP_BACKGROUND_WIDTH_RATIO_ };
    ...
    void PopupStageSpellbook::SetSpellbookPageRightColors()
    {
    ...
    void PopupStageSpellbook::SetupSpellbookPageRightForFadeIn()
    {
        SetupSpellbookPageRightText(spellCurrentPtr_);
    ...
    void PopupStageSpellbook::MoveSpellbookPageRightColors(const float ELAPSED_TIME_SECONDS)
    {
    ...
    void PopupStageSpellbook::SetupSpellbookPageRightText(
