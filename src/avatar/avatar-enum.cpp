...
namespace avatar
{
    ...
    const std::string Avatar::ToString(const NameEnum ENUM)
    {
        switch (ENUM)
        {
            case NameEnum::Metal: return "Metal";
            case NameEnum::Puck: return "Puck";
            case NameEnum::Sara: return "Sara";
            case NameEnum::Girl: return "Girl";
            case NameEnum::Circus: return "Circus";
            case NameEnum::Poor: return "Poor";
            case NameEnum::Rags: return "Rags";
            case NameEnum::Common: return "Common";
            case NameEnum::Tunic: return "Tunic";
            case NameEnum::Pants: return "Pants";
            case NameEnum::Maid: return "Maid";
            case NameEnum::Robes: return "Robes";
            case NameEnum::Whitebeard: return "Whitebeard";
            case NameEnum::Dress: return "Dress";
            case NameEnum::Private: return "Private";
            case NameEnum::Private2nd: return "Private2nd";
            case NameEnum::Private1st: return "Private1st";
            case NameEnum::Specialist: return "Specialist";
            case NameEnum::Corporal: return "Corporal";
            case NameEnum::Sergeant: return "Sergeant";
            case NameEnum::Major: return "Major";
            case NameEnum::Knight: return "Knight";
            case NameEnum::KnightGold: return "KnightGold";
            case NameEnum::Thug: return "Thug";
            case NameEnum::ManAtArms: return "ManAtArms";
            case NameEnum::Gladiator: return "Gladiator";
            case NameEnum::Iron: return "Iron";
            case NameEnum::Monk: return "Monk";
            default:
            {
                M_HP_LOG_ERR(
    ...
    const std::vector<Avatar::Enum> Avatar::Avatars(const NameEnum ENUM)
    {
        switch (ENUM)
        {
            ...
            case NameEnum::Whitebeard: return { Avatar::Robes_Whitebeard };
            case NameEnum::Dress:
            {
            ...
            case NameEnum::Major: return { Avatar::Plate_Major_Dark, Avatar::Plate_Major_Light };
            case NameEnum::Knight: return { Avatar::Plate_Knight };
            case NameEnum::KnightGold: return { Avatar::Plate_Knight_Gold };
            case NameEnum::Thug:
            {
