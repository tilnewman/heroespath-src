    ...
    const std::string TavernTalk::Compose(const player::Party & party)
    {
        ...
        if ((misc::random::Int(10) == 0) && (DoesPartyHaveBeasts(party)))
        {
            ...
            switch (misc::random::Int(6))
            {
                ...
                default:
                {
                    secondPart = "sing drinking songs" + Random(StrVec_t{ " with us", " too", "" });
                    break;
                }
            }
        ...
        switch(misc::random::Int(24))
        {
            ...
            case 1:
            {
                return AppendIf(RandomOrEmpty(TavernNoises())) +
                    ...
                    AppendIf(RandomOrEmpty(TavernNoises())) +
                    "So don't sing so loud.";
            }
            case 2:
            {
            ...
            case 6:
            {
                return Random(TavernNoises()) +
                    "  I really " +
                    Random(StrVec_t{ "love", "hate", "pity" }) +
                    " all of you" +
            ...
            case 7:
            {
                return AppendIf(RandomOrEmpty(TavernNoises())) +
                    ...
                    "Another round of " +
                    Random(TavernDrinks()) +
                    " for me and my six new friends here.";
            }
            case 8:
            {
                return Random(StrVec_t{ "Why do they ", "They shouldn't " }) +
                    Random(StrVec_t{ "allow ", "let " }) +
                    "your kind in here.";
            }
            case 9:
            {
            ...
            case 11:
            {
                return AppendIf(RandomOrEmpty(TavernNoises())) +
                    "Watch me " +
                    Random(StrVec_t{ "balance", "pour" }) +
                    " this " +
                    Random(TavernDrinks()) +
                    " on " +
                    Random(StrVec_t{ "his", "her", "my", "your", "that guy's" }) +
                    " head.";
            }
            case 12:
            {
            ...
            {
                return AppendIf(RandomOrEmpty(TavernNoises())) +
                    "Watch how much of this " +
                    AppendIf(RandomOrEmpty(TavernDrinkAdjectives()), " ") +
                    Random(TavernDrinks()) +
                    " I can " +
                    Random(StrVec_t{ "guzzle", "drink", "chug", "spill", "piss on the floor" }) +
                    PeriodOrBang();
            }
            case 15:
            {
                return AppendIf(RandomOrEmpty(TavernNoises())) +
                    Random(StrVec_t{ "Hey, who ", "Who " }) +
                    "stole my " +
                    AppendIf(RandomOrEmpty(TavernDrinkAdjectives()), " ") +
                    Random(TavernDrinks()) +
                    "?";
            ...
            case 18:
            {
                return "Hey.  " +
                    AppendIf(RandomOrEmpty(TavernNoises())) +
                    Random(StrVec_t{ "Hey you.", "Hey." }) +
                    "  Watch me " +
                    Random(StrVec_t{ "drink", "spill" }) +
                    " this " +
                    AppendIf(RandomOrEmpty(TavernDrinkAdjectives()), " ") +
                    Random(TavernDrinks()) +
                    ".";
            ...
            {
                return AppendIf(RandomOrEmpty(TavernNoises())) +
                    Random(StrVec_t{ "I've had", "I think I've had"}) +
                    " too much of this " +
                    AppendIf(RandomOrEmpty(TavernDrinkAdjectives()), " ") +
                    Random(TavernDrinks()) +
                    ".";
            ...
            {
                return "What are " +
                    AppendIf(RandomOrEmpty(StrVec_t{ "all", "all of" }), " ") +
                    "you looking at" +
                    Random(StrVec_t{ "?", "?!" });
            }
            case 21:
            ...
            case 22:
            {
                return "You look like you could use " +
                    Random(std::vector<StrVec_t>{
                        ...
                        { "some of this " + Random(Combinations(TavernDrinkAdjectives(), TavernDrinks())) } }) +
                    ".";
            }
            case 23:
            {
