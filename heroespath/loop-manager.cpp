...
#include "heroespath/stage/loop-cmd-addstage.hpp"
...
namespace heroespath
{
    ...
    void LoopManager::TransitionTo_Credits()
    {
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         LoopState::Credits,
                         sfml_util::ILoopCmdSPtr_t( new heroespath::stage::LoopCmd_AddStage_Credits(currentLoopSPtr_) ),
                         sfml_util::music::All);
    ...
    void LoopManager::TransitionTo_MainMenu()
    {
        TransitionHelper(false,//WILL_CLEAR_QUEUE
                         ...
                         LoopState::MainMenu,
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_MainMenu(currentLoopSPtr_)),
    ...
    void LoopManager::TransitionTo_Settings()
    {
        ...
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         true, //WILL_FINAL_EXECUTE
                         LoopState::Settings,
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_Settings(currentLoopSPtr_)),
                         sfml_util::music::All,
                         sfml_util::music::Theme);
    ...
    void LoopManager::TransitionTo_CharacterCreation()
    {
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_Character_Creation(currentLoopSPtr_)),
                         sfml_util::music::All,
                         sfml_util::music::Wind);
    }
    ...
    void LoopManager::TransitionTo_PartyCreation()
    {
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_Party_Creation(currentLoopSPtr_)),
                         sfml_util::music::All,
    ...
    void LoopManager::TransitionTo_Inn()
    {
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         true, //WILL_FINAL_EXECUTE
                         LoopState::Inn,
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_Inn(currentLoopSPtr_)));
    }
    ...
    void LoopManager::TransitionTo_Camp()
    {
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         false,//WILL_FINAL_EXECUTE
                         LoopState::Camp,
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_Camp(currentLoopSPtr_)),
                         sfml_util::music::All,
    ...
    void LoopManager::TransitionTo_LoadGameMenu()
    {
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_LoadGameMenu(currentLoopSPtr_)));
    }
    ...
    void LoopManager::TransitionTo_Combat()
    {
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         true, //WILL_FINAL_EXECUTE
                         LoopState::Combat,
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_Combat(currentLoopSPtr_)),
                         sfml_util::music::All,
                         sfml_util::music::None);
    }
    ...
    void LoopManager::TransitionTo_Test()
    {
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         true, //WILL_FINAL_EXECUTE
                         LoopState::Test,
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_Test(currentLoopSPtr_)),
                         sfml_util::music::All,
                         sfml_util::music::None);
    }
    ...
    void LoopManager::TransitionTo_Inventory(creature::CreaturePtr_t creaturePtr)
    {
        ...
        TransitionHelper(true, //WILL_CLEAR_QUEUE
                         ...
                         true, //WILL_FINAL_EXECUTE
                         LoopState::Inventory,
                         sfml_util::ILoopCmdSPtr_t(new heroespath::stage::LoopCmd_AddStage_Inventory(currentLoopSPtr_, creaturePtr)),
                         sfml_util::music::None,
                         sfml_util::music::None);
    }
    ...
    sfml_util::DisplayChangeResult::Enum LoopManager::ChangeResolution(sfml_util::IStage * const                     currentStagePtr_,
                                                                       heroespath::callback::IPopupHandler_t * const HANDLER_PTR,
                                                                       ...
                                                                       const unsigned                                ANTIALIAS_LEVEL)
    {
        ...
        const heroespath::PopupInfo POPUP_INFO("ResolutionChange",
                                               textInfo,
