#ifndef APPBASE_HEROESPATH_POPUPINFO_INCLUDED
#define APPBASE_HEROESPATH_POPUPINFO_INCLUDED
//
// popup-info.hpp
...
#include "heroespath/which-popup-enum.hpp"
...
namespace heroespath
{
    ...
    public:
        ...
        PopupInfo(const std::string &                     NAME,
                  ...
                  const heroespath::Popup::Enum           TYPE                 = heroespath::Popup::Generic,
        ...
        inline heroespath::Popup::Enum           Type() const               { return type_; }
...
#endif //APPBASE_HEROESPATH_POPUPINFO_INCLUDED
