...
namespace stage
{
    ...
    bool SettingsStage::HandleCallback(const heroespath::callback::PopupResponse & POPUP)
    {
        ...
        if (POPUP.Response() == sfml_util::Response::No)
        {
            ...
            heroespath::LoopManager::Instance()->ChangeResolution(this, this, sfml_util::Display::Instance()->GetCurrentResolution(), prevAALevel_);
