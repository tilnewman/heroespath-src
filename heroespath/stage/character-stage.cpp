...
namespace stage
{
    ...
    {
        M_ASSERT_OR_LOGANDTHROW_SS((RADIOBUTTON_WRAPPER.PTR_ != nullptr), "heroespath::CharacterStage::HandleCallback() given a null RADIOBUTTON_PACKAGE.PTR_.");
    ...
    bool CharacterStage::HandleCallback(const heroespath::callback::PopupResponse & POPUP_RESPONSE)
    {
            ...
            (sfml_util::Response::IsAffirmative(POPUP_RESPONSE.Response())))
        {
            ...
            const creature::role::Enum  ROLE_ENUM(static_cast<creature::role::Enum>(((RACE_ENUM == creature::race::Wolfen) ? creature::role::Wolfen : roleRadioButtonSPtr_->GetSelectedNumber())));
            ...
            player::CharacterSPtr_t newCharacterSPtr( new player::Character(NAME,
                                                                            ...
                                                                            1,
                                                                            0,
                                                                            heroespath::creature::ConditionSVec_t(),
                                                                            heroespath::creature::TitlePVec_t(),
                                                                            heroespath::item::Inventory(),
            ...
            heroespath::state::GameStateFactory::Instance()->SaveCharacter(newCharacterSPtr);
...
sfml_util::PopupImage::Large));
                 ...
                 (POPUP_RESPONSE.Response() != sfml_util::Response::Cancel))
        {
            ...
            const creature::role::Enum ROLE(static_cast<creature::role::Enum>(((RACE == creature::race::Wolfen) ? creature::role::Wolfen : roleRadioButtonSPtr_->GetSelectedNumber())));
...
sfml_util::PopupImage::Regular));
    ...
    void CharacterStage::AdjustRoleRadioButtonsForRace(const heroespath::creature::race::Enum WHICH_RACE)
    {
    ...
    void CharacterStage::Setup()
    {
        ...
        fixedStatsSVec_[stats::stat::Strength].reset(       new AnimNum(stats::INITIAL_STAT_MIN - 1, stats::stat::Strength,     statsFirstNumPosLeft_, statsStrPosTop_, statsFirstNumPosLeft_, statsStrPosTop_, statTextInfo) );
        fixedStatsSVec_[stats::stat::Accuracy].reset(       new AnimNum(stats::INITIAL_STAT_MIN - 1, stats::stat::Accuracy,     statsFirstNumPosLeft_, statsAccPosTop_, statsFirstNumPosLeft_, statsAccPosTop_, statTextInfo) );
        fixedStatsSVec_[stats::stat::Charm].reset(          new AnimNum(stats::INITIAL_STAT_MIN - 1, stats::stat::Charm,        statsFirstNumPosLeft_, statsChaPosTop_, statsFirstNumPosLeft_, statsChaPosTop_, statTextInfo) );
        fixedStatsSVec_[stats::stat::Luck].reset(           new AnimNum(stats::INITIAL_STAT_MIN - 1, stats::stat::Luck,         statsFirstNumPosLeft_, statsLckPosTop_, statsFirstNumPosLeft_, statsLckPosTop_, statTextInfo) );
        fixedStatsSVec_[stats::stat::Speed].reset(          new AnimNum(stats::INITIAL_STAT_MIN - 1, stats::stat::Speed,        statsFirstNumPosLeft_, statsSpdPosTop_, statsFirstNumPosLeft_, statsSpdPosTop_, statTextInfo) );
        fixedStatsSVec_[stats::stat::Intelligence].reset(   new AnimNum(stats::INITIAL_STAT_MIN - 1, stats::stat::Intelligence, statsFirstNumPosLeft_, statsIntPosTop_, statsFirstNumPosLeft_, statsIntPosTop_, statTextInfo) );
        ...
        AdjustRoleRadioButtonsForRace(static_cast<heroespath::creature::race::Enum>(0));
    ...
    {
        const creature::role::Enum ROLE_ENUM( static_cast<creature::role::Enum>(((raceRadioButtonSPtr_->GetSelectedNumber() == creature::race::Wolfen) ? creature::role::Wolfen: roleRadioButtonSPtr_->GetSelectedNumber())));
                                         ...
                                         sfml_util::gui::TextInfo & textInfo) const
    {
        ...
        const creature::role::Enum WHICH_ROLE(static_cast<creature::role::Enum>(((raceRadioButtonSPtr_->GetSelectedNumber() == creature::race::Wolfen) ? creature::role::Wolfen : roleRadioButtonSPtr_->GetSelectedNumber())));
    ...
    sfml_util::gui::IGuiEntitySPtr_t CharacterStage::UpdateMouseUp(const sf::Vector2f & MOUSE_POS_V)
    {
        ...
        if (wereAnyHeldDown)
        {
            ...
            sfml_util::SoundManager::Instance()->StaticSounds_Thock()->PlayRandom();
        }
