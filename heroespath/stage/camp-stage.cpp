...
namespace stage
{
    ...
    bool CampStage::HandleCallback(const heroespath::callback::PopupResponse & PACKAGE)
    {
    ...
    void CampStage::Setup()
    {
        ...
        showNewGamePopup1_ = heroespath::Game::Instance()->State()->IsNewGame();
    }
    ...
    void CampStage::UpdateTime(const float ELAPSED_TIME_SECONDS)
    {
        ...
        {
            const heroespath::PopupInfo POPUP_INFO( sfml_util::gui::PopupManager::Instance()->CreatePopupInfo(NEWGAME_POPUP_NAME1_,
        ...
        {
            const heroespath::PopupInfo POPUP_INFO( sfml_util::gui::PopupManager::Instance()->CreatePopupInfo(NEWGAME_POPUP_NAME2_,
        ...
        {
            const heroespath::PopupInfo POPUP_INFO( sfml_util::gui::PopupManager::Instance()->CreatePopupInfo(NEWGAME_POPUP_NAME3_,
        ...
        {
            const heroespath::PopupInfo POPUP_INFO( sfml_util::gui::PopupManager::Instance()->CreatePopupInfo(NEWGAME_POPUP_NAME4_,
    ...
    {
        std::ostringstream ss;
        ss << heroespath::GameDataFile::Instance()->GetCopyStr("heroespath-intro-text2");
