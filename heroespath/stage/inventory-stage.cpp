...
namespace stage
{
    ...
    {
        M_ASSERT_OR_LOGANDTHROW_SS((creaturePtr != nullptr), "heroespath::stage::InventoryStage::InventoryStage() was given a null creature shared pointer.");
    ...
    bool InventoryStage::HandleCallback(const heroespath::callback::PopupResponse & POPUP_RESPONSE)
    {
    ...
    {
        heroespath::LoopManager::Instance()->Goto_Previous();
        return true;
    }
    ...
    {
        std::ostringstream ss;
        ss << "Character # " << heroespath::Game::Instance()->State()->Party()->GetOrderNum(creaturePtr_) + 1 << "\n"
            << creaturePtr_->Name() << "\n"
    ...
    void InventoryStage::PopupContentSelectionWindow(const std::string & PROMPT_TEXT)
    {
        ...
        const PopupInfo POPUP_INFO_DONE(sfml_util::gui::PopupManager::Instance()->CreatePopupInfo(POPUP_NAME_CONTENTSELECTION_,
                                                                                                  ...
                                                                                                  sfml_util::Justified::Center,
                                                                                                  sfml_util::sound_effect::PromptGeneric,
                                                                                                  heroespath::Popup::ContentSelectionWithoutItem,
                                                                                                  sfml_util::FontManager::Instance()->Size_Normal()));
        LoopManager::Instance()->PopupWaitBegin(this, POPUP_INFO_DONE);
        isWaitingOnPopup_ = true;
    }
