#ifndef APPBASE_HEROESPATH_CHARACTERSTAGE_INCLUDED
#define APPBASE_HEROESPATH_CHARACTERSTAGE_INCLUDED
//
// character-stage.hpp
...
#include "heroespath/stage/character-stage-anim-num.hpp"
...
namespace stage
{
    ...
    public:
        ...
        void AdjustRoleRadioButtonsForRace(const heroespath::creature::race::Enum WHICH_RACE);
...
#endif //APPBASE_HEROESPATH_CHARACTERSTAGE_INCLUDED
