...
namespace ownership
{
    ...
    const std::string wealth_type::ToString(const wealth_type::Enum E)
    {
        switch (E)
        {
            ...
            default:
            {
                ...
                ss << "heroespath::non_player::ownership::wealth_type::ToString(" << E << ")_InvalidValueError.";
    ...
    const std::string complexity_type::ToString(const complexity_type::Enum E)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::non_player::ownership::complexity_type::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
