...
namespace creature
{
    ...
    const std::string sex::ToString(const sex::Enum E)
    {
        switch (E)
        {
            ...
            default:
            {
                ...
                ss << "heroespath::creature::sex::Enum::ToString(" << E << ")_InvalidValueError.";
    ...
    const std::string sex::HeSheIt(const sex::Enum E, const bool WILL_CAPITALIZE)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::creature::sex::Enum::HisHersIts(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
    ...
    const std::string sex::HimHerIt(const sex::Enum E, const bool WILL_CAPITALIZE)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::creature::sex::Enum::HimHerIt(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
