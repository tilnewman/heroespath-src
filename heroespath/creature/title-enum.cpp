...
namespace creature
{
    ...
    const std::string title::ToString(const title::Enum E)
    {
        switch (E)
        {
            case ProtectorOfThornberry: { return "ProtectorOfThornberry"; }
            //
            case Dodger:                { return "Dodger"; }
            case FastFoot:              { return "FastFoot"; }
            case NimbleFoot:            { return "NimbleFoot"; }
            case SwiftFoot:             { return "SwiftFoot"; }
            case MeleeMover:            { return "MeleeMover"; }
            case MeleeGrace:            { return "MeleeGrace"; }
            case MeleeDancer:           { return "MeleeDancer"; }
            case MeleeShadow:           { return "MeleeShadow"; }
            //
            case SkyDodger:             { return "SkyDodger"; }
            case FastWing:              { return "FastWing"; }
            case NimbleWing:            { return "NimbleWing"; }
            case SwiftWing:             { return "SwiftWing"; }
            case SkyMover:              { return "SkyMover"; }
            case GraceWing:             { return "GraceWing"; }
            case SkyDancer:             { return "SkyDancer"; }
            case SkyShadow:             { return "SkyShadow"; }
            //
            ...
            case ShadowWalker:          { return "ShadowWalker"; }
            case Assassin:              { return "Assassin"; }
            //
            case KnightOfTheClashingBlade:  { return "KnightOfTheClashingBlade"; }
            case KnightOfAHundredBattles:   { return "KnightOfAHundredBattles"; }
            case KnightOfThePiercingBlade:  { return "KnightOfThePiercingBlade"; }
            case KnightOfTheUndauntedBlade: { return "KnightOfTheUndauntedBlade"; }
            case KnightOfAThousandBattles:  { return "KnightOfAThousandBattles"; }
            case KnightOfTheFearedBlade:    { return "KnightOfTheFearedBlade"; }
            case KnightOfTheRealm:          { return "KnightOfTheRealm"; }
            case KnightOfEtan:              { return "KnightOfEtan"; }
            //
            case Mender:                    { return "Mender"; }
            case Healer:                    { return "Healer"; }
            case BlessedHands:              { return "BlessedHands"; }
            case WitchDoctor:               { return "WitchDoctor"; }
            case LightOfTheCure:            { return "LightOfTheCure"; }
            case DivineTouch:               { return "DivineTouch"; }
            case OrderOfTheWhiteSage:       { return "OrderOfTheWhiteSage"; }
            case ClericOfTheCovenant:       { return "ClericOfTheCovenant"; }
            //
            case HandsOfCharity:            { return "HandsOfCharity"; }
            case HandsOfLove:               { return "HandsOfLove"; }
            case HandsOfDevotion:           { return "HandsOfDevotion"; }
            case HandsOfNobility:           { return "HandsOfNobility"; }
            case HandsOfSacrifice:          { return "HandsOfSacrifice"; }
            case TheSelflessHand:           { return "TheSelflessHand"; }
            case TheIncorruptibleHand:      { return "TheIncorruptibleHand"; }
            case OrderOfTheBleedingPalm:    { return "OrderOfTheBleedingPalm"; }
            //
            case HowlingStray:              { return "HowlingStray"; }
            case HowlingBully:	            { return "HowlingBully"; }
            case HowlingWildling:	        { return "HowlingWildling"; }
            case SnarlingCreature:          { return "SnarlingCreature"; }
            case SnarlingBeast:             { return "SnarlingBeast"; }
            case SnarlingFiend:             { return "SnarlingFiend"; }
            case RagingMonster:             { return "RagingMonster"; }
            case RagingHorror:              { return "RagingHorror"; }
            //
            case Prowler:                   { return "Prowler"; }
            case PickPocket:                { return "PickPocket"; }
            case CatBurglar:                { return "CatBurglar"; }
            case Clincher:                  { return "Clincher"; }
            case Picker:                    { return "Picker"; }
            case SafeCracker:               { return "SafeCracker"; }
            case LockTickler:               { return "LockTickler"; }
            case LockBane:                  { return "LockBane"; }
            //
            ...
            //
            case BardOfTheTrippingToes:     { return "BardOfTheTrippingToes"; }
            case BardOfTheMerryMelody:      { return "BardOfTheMerryMelody"; }
            case BardOfTheWhimsicalWord:    { return "BardOfTheWhimsicalWord"; }
            case BardOfTheCarolingChorus:   { return "BardOfTheCarolingChorus"; }
            case BardOfTheBouncingBallad:   { return "BardOfTheBouncingBallad"; }
            case BardOfTheDancingDitty:     { return "BardOfTheDancingDitty"; }
            case BardOfTheEnchantedEar:     { return "BardOfTheEnchantedEar"; }
            case BardOfTheAracneAria:       { return "BardOfTheAracneAria"; }
            //
            case Targeter:                  { return "Targeter"; }
            case SteadfastFlyer:            { return "SteadfastFlyer"; }
            case DeadEye:                   { return "DeadEye"; }
            case DeadCenter:                { return "DeadCenter"; }
            case SureSail:                  { return "SureSail"; }
            case SureShot:                  { return "SureShot"; }
            case PerfectHit:                { return "PerfectHit"; }
            case EnchantedAim:              { return "EnchantedAim"; }
            //
            ...
            //
            case PawOfTheLunarPup:	        { return "PawOfTheLunarPup"; }
            case PawOfTheYoungHowler:       { return "PawOfTheYoungHowler"; }
            case PawOfTheNightSky:          { return "PawOfTheNightSky"; }
            case PawOfTheMidnightWail:      { return "PawOfTheMidnightWail"; }
            case PawOfTheTwilightMoon:      { return "PawOfTheTwilightMoon"; }
            case PawOfTheCelestialCry:      { return "PawOfTheCelestialCry"; }
            case PawOfTheGlowingOrb:        { return "PawOfTheGlowingOrb"; }
            case PawOfTheCrescentLegion:    { return "PawOfTheCrescentLegion"; }
            //
            case WindGlider:                { return "WindGlider"; }
            case LightFeather:              { return "LightFeather"; }
            case FreeFlyer:                 { return "FreeFlyer"; }
            case SteadyWing:                { return "SteadyWing"; }
            case EverSoar:                  { return "EverSoar"; }
            case SkySail:                   { return "SkySail"; }
            case Aerialist:                 { return "Aerialist"; }
            case FeatherDancer:             { return "FeatherDancer"; }
            //
            case PackFollower:              { return "PackFollower"; }
            case PackMember:                { return "PackMember"; }
            case PackTasker:                { return "PackTasker"; }
            case PackCharger:               { return "PackCharger"; }
            case PackNobel:                 { return "PackNobel"; }
            case PackLeader:                { return "PackLeader"; }
            case PackAlpha:                 { return "PackAlpha"; }
            case PackElder:                 { return "PackElder"; }
            //
            case CritterClairvoyant:        { return "CritterClairvoyant"; }
            case AnimalAnimator:            { return "AnimalAnimator"; }
            case FriendOfTheFeral:          { return "FriendOfTheFeral"; }
            case WillOfTheWild:             { return "WillOfTheWild"; }
            case CreatureChanneler:         { return "CreatureChanneler"; }
            case BeastTaskmaster:           { return "BeastTaskmaster"; }
            case MonsterManipulator:        { return "MonsterManipulator"; }
            case MammalianMaster:           { return "MammalianMaster"; }
            //
            case Brawler:                   { return "Brawler"; }
            case WildSwing:                 { return "WildSwing"; }
            case HavocSmasher:              { return "HavocSmasher"; }
            case SureStroke:                { return "SureStroke"; }
            ...
            case DragonOfTheDaggerTooth:        { return "DragonOfTheDaggerTooth"; }
            case DragonOfTheForebodingGaze:     { return "DragonOfTheForebodingGaze"; }
            case DragonOfTheUnbreakableScale:   { return "DragonOfTheUnbreakableScale"; }
            case DragonOfTheDreadedBreath:      { return "DragonOfTheDreadedBreath"; }
            case DragonOfTheArcaneWing:         { return "DragonOfTheArcaneWing"; }
            case DragonOfTheNightmareSky:       { return "DragonOfTheNightmareSky"; }
            //
            case Count:
            default:
            {
                std::ostringstream ss;
                ss << "heroespath::creature::title::Enum::ToString(" << E << ")_InvalidValueError.";
    ...
    const std::string title::Name(const title::Enum E)
    {
        switch (E)
        {
            ...
            case BardOfTheAracneAria:       { return "Bard of the Aracne Aria"; }
            //
            case Targeter:                  { return "Targeter"; }
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::creature::title::Enum::Name(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
