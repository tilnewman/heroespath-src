#ifndef APPBASE_HEROESPATH_LOCATION_LOCATION_INCLUDED
#define APPBASE_HEROESPATH_LOCATION_LOCATION_INCLUDED
//
// location.hpp
...
#endif //APPBASE_HEROESPATH_LOCATION_LOCATION_INCLUDED
