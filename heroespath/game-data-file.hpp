#ifndef APPBASE_HEROESPATH_GAMEDATAFILE_INCLUDED
#define APPBASE_HEROESPATH_GAMEDATAFILE_INCLUDED
//
// game-data-file.hpp
...
namespace heroespath
{
    ...
    class GameDataFile : public appbase::ConfigBase
    {
        ...
        GameDataFile(const GameDataFile &);

        //prevent copy assignment
        GameDataFile & operator=(const GameDataFile &);
...
#endif //APPBASE_HEROESPATH_GAMEDATAFILE_INCLUDED
