...
namespace armor
{
    ...
    const std::string shield_type::ToString(const shield_type::Enum E)
    {
        switch(E)
        {
            ...
            default:
            {
                ...
                ss << "heroespath::item::armor::shield_type::ToString(" << E << ")_InvalidValueError.";
    ...
    const std::string helm_type::ToString(const helm_type::Enum E)
    {
        switch(E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::armor::helm_type::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        };
    }
    ...
    const std::string base_type::ToString(const base_type::Enum E)
    {
        switch(E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::armor::base_type::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        };
    }
    ...
    const std::string cover_type::ToString(const cover_type::Enum E)
    {
        switch(E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::armor::cover_type::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        };
    }
