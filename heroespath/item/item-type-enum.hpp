#ifndef APPBASE_HEROESPATH_ITEM_ITEMTYPEENUM_INCLUDED
#define APPBASE_HEROESPATH_ITEM_ITEMTYPEENUM_INCLUDED
//
// item-type-enum.hpp
...
#endif //APPBASE_HEROESPATH_ITEM_ITEMTYPEENUM_INCLUDED
