...
namespace item
{
    ...
    const std::string misc_type::ToString(const misc_type::Enum E)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::misc_type::ToString(" << E << ")_InvalidValueError.";
    ...
    const std::string material::ToString(const item::material::Enum E)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::material::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
    ...
    stats::Armor_t material::ArmorRatingBonusPri(const material::Enum MATERIAL_PRI)
    {
        switch (MATERIAL_PRI)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::material::ArmorRatingBonusPri(" << MATERIAL_PRI << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
    ...
    item::Coin_t material::PriceAdjPri(const material::Enum MATERIAL_PRI)
    {
        switch (MATERIAL_PRI)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::material::PriceAdjPri(" << MATERIAL_PRI << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    ...
    float material::WeightMultPri(const material::Enum MATERIAL_PRI)
    {
        switch (MATERIAL_PRI)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::material::WeightMultPri(" << MATERIAL_PRI << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
    ...
    float material::FireDamageRatio(const material::Enum PRI, const material::Enum SEC)
    {
        ...
        switch (PRI)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::FireDamageRatio(material_pri=" << PRI << ", material_sec=...) -but that material_pri type is unknown.";
                throw std::range_error(ss.str());
            }
        }
        switch (SEC)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::FireDamageRatio(material_pri=" << material::ToString(PRI) << ", material_sec=" << SEC << " -but that material_sec type is unknown.";
                throw std::range_error(ss.str());
            }
        }
