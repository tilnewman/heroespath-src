...
namespace weapon
{
    ...
    const std::string sword_type::ToString(const sword_type::Enum E)
    {
        switch(E)
        {
            ...
            default:
            {
                ...
                ss << "heroespath::item::weapon::sword_type::ToString(" << E << ")_InvalidValueError.";
    ...
    const std::string axe_type::ToString(const axe_type::Enum E)
    {
        switch(E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::weapon::axe_type::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
    ...
    const std::string club_type::ToString(const club_type::Enum E)
    {
        switch(E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::weapon::club_type::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
    ...
    const std::string whip_type::ToString(const whip_type::Enum E)
    {
        switch(E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::weapon::whip_type::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
    ...
    const std::string projectile_type::ToString(const projectile_type::Enum E)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::weapon::projectile_type::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
    ...
    const std::string bladedstaff_type::ToString(const bladedstaff_type::Enum E)
    {
        switch (E)
        {
            ...
            {
                std::ostringstream ss;
                ss << "heroespath::item::weapon::bladedstaff_type::ToString(" << E << ")_InvalidValueError.";
                throw std::range_error(ss.str());
            }
        }
    }
