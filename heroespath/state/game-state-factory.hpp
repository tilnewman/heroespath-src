#ifndef APPBASE_HEROESPATH_STATE_GAMESTATEFACTORY_INCLUDED
#define APPBASE_HEROESPATH_STATE_GAMESTATEFACTORY_INCLUDED
//
...
#endif //APPBASE_HEROESPATH_STATE_GAMESTATEFACTORY_INCLUDED
