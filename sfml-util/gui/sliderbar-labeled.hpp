#ifndef APPBASE_SFMLUTIL_GUI_SLIDERBARLABELED_INCLUDED
#define APPBASE_SFMLUTIL_GUI_SLIDERBARLABELED_INCLUDED
//
...
#endif //APPBASE_SFMLUTIL_GUI_SLIDERBARLABELED_INCLUDED
